...
export function TransportationBuilder({ 
  entries, 
  onChange, 
  inputMethod, 
  overallMargin, 
          ...
          >
            <div className="flex items-center justify-between mb-2">
              <h4 className="font-semibold flex items-center gap-2">
                ...
                {t('builders.transportationEntry', { number: index + 1 })}
              </h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                <Label>{t('builders.vehicleTypeRequired')}</Label>
                <Select
                  value={entry.vehicleType}
                  onValueChange={(val) => updateEntry(index, "vehicleType", val)}
                >
                  <SelectTrigger>
                    <SelectValue placeholder={t('builders.selectVehicle')} />
                  </SelectTrigger>
                  <SelectContent>
                    {vehicleTypes.map(vt => (
              ...
              <div className="space-y-2">
                <Label>{t('builders.numberOfVehiclesRequired')}</Label>
                <Input
                  type="number"
                  min="1"
        ...
        <table className="w-full text-sm">
          <thead className="bg-green-50 border-b">
            <tr>
              ...
              <th className="p-2 text-left min-w-[120px]">{t('builders.tableHeaderVehicle')}</th>
              ...
              <th className="p-2 text-left">{t('builders.tableHeaderVehicles')}</th>
